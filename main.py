...
def handle(phrase):
    ...
    elif len(set(phrase) & {'лучший', 'топовый', 'понравиться', 'востребованный'}) != 0:
    ...
    elif (len(set(phrase) & {'помоги', 'какой', 'вывести', 'показать', 'покажи', 'написать', 'найти', 'искать', 'подсказать'}) != 0
