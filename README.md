## Диалоговая система с элементами ИИ
Система представляет собой [приложение](main.py) для взаимодействия с 
данными посредством текстовых запросов.
Все данные содержатся в [dataset.txt](doc/dataset.txt)
